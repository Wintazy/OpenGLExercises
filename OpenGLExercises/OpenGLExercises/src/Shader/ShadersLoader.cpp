...
void ShadersLoader::SetMat4f(const std::string &name, const glm::mat4 value) const
{
	glUniformMatrix4fv(glGetUniformLocation(m_shaderProgramId, name.c_str()), 1, GL_FALSE, glm::value_ptr(value));
}
